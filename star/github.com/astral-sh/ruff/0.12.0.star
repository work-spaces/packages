...
"""
Spaces starlark checkout for https://github.com/astral-sh/ruff:0.12.0
"""
...
platforms = {
  "linux-aarch64": {
    ...
    "url": "https://github.com/astral-sh/ruff/releases/download/0.12.0/ruff-aarch64-unknown-linux-musl.tar.gz"
  },
  "linux-x86_64": {
    "add_prefix": "sysroot/bin",
    "link": "Hard",
    ...
    "url": "https://github.com/astral-sh/ruff/releases/download/0.12.0/ruff-x86_64-unknown-linux-musl.tar.gz"
  },
  "macos-aarch64": {
    "add_prefix": "sysroot/bin",
    "link": "Hard",
  ...
  "macos-x86_64": {
    ...
    "url": "https://github.com/astral-sh/ruff/releases/download/0.12.0/ruff-x86_64-apple-darwin.tar.gz"
  },
  "windows-x86_64": {
    "add_prefix": "sysroot/bin",
    "link": "Hard",
