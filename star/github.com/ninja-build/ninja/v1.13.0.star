...
"""
Spaces starlark checkout for https://github.com/ninja-build/ninja:v1.13.0
"""
...
platforms = {
  "linux-aarch64": {
    ...
    "url": "https://github.com/ninja-build/ninja/releases/download/v1.13.0/ninja-linux-aarch64.zip"
  },
  "linux-x86_64": {
    "add_prefix": "sysroot/bin",
    "link": "Hard",
